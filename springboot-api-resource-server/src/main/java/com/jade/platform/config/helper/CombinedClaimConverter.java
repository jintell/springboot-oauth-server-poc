package com.jade.platform.config.helper;
 ...
 * @Date: 9/21/23
 * This is a custom converter to extract all entries of two Jwt claims "scope" and "roles". All
 * findings prefixed with the "ROLE_" prefixes will remove the prefix, and then wrapped up as a
